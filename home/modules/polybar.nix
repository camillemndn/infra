...
in
{
  services.polybar = {
    ...
    config = {
      ...
      "module/distro-icon" = {
        type = "custom/script";
        exec = "${pkgs.coreutils}/bin/uname -nr | ${pkgs.coreutils}/bin/cut -d- -f1";
        interval = 999999999;
      ...
      "module/network" = {
        ...
        exec = "${pkgs.coreutils}/bin/ls /sys/class/net | ${pkgs.gnugrep}/bin/grep -E 'enp|eth'";
        interface = "wlp6s0";
      ...
      "module/powermenu" = {
        ...
        menu-0-0 = " Suspendre";
        menu-0-0-exec = "${pkgs.systemd}/bin/systemctl suspend";
        menu-0-1 = " Redémarrer";
        menu-0-1-exec = "${pkgs.systemd}/bin/systemctl reboot";
        menu-0-2 = " Arrêter";
        menu-0-2-exec = "${pkgs.systemd}/bin/systemctl poweroff";
      };

      "module/wireless-network" = {
        type = "internal/network";
        exec = "${pkgs.coreutils}/bin/ls /sys/class/net | ${pkgs.gnugrep}/bin/grep wlp";
        interface = "wlp6s0";
      };
