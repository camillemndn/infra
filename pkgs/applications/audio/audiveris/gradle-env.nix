...
let
  ...
  inherit (lib)
    assertMsg concatMapStringsSep groupBy' hasSuffix hasPrefix mapAttrs
  ...
  mkInitScript = projectSpec: gradle:
    let
      ...
      hasDependencies = mapAttrs (_type: deps: deps != [ ]) projectSpec.dependencies;
